...
struct OrdersAPIClient: APIClient {
    ...
    func CreateOrder(products: [String: Any], userId: String, userData: [String: Any]?, paymentId: String, oneClickBuy: Bool, completion: @escaping (APIResult<PlaceOrderResult?, MoyaError>) -> Void) {
        fetch(with: OrdersEndpoint.create(products: products, userId: userId, userData: userData, paymentId: paymentId, oneClickBuy: oneClickBuy), completion: completion)
    }

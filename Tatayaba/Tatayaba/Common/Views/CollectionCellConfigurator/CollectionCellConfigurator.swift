...
class CollectionCellConfigurator<CellType: ConfigurableCell, CellDataType: Hashable>: CellConfigurator where CellType.CellDataType == CellDataType, CellType: UICollectionViewCell {

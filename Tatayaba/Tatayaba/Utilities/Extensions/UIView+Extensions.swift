...
extension UIView {
    ...
    @objc func addSubViewWithAutoLayout(view: UIView) {
...
extension UIView {
    ...
    func addBottomBorder(color: UIColor = #colorLiteral(red: 0.1335985065, green: 0.102928184, blue: 0.2107295692, alpha: 1), margins: CGFloat = 0, borderLineSize: CGFloat = 1) {
        let border = UIView()
